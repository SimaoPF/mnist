...
num_classes = 10
epochs = 12
str_name = 'Mnist_mod1_Adam_'+ time.asctime()
...
saver = callbacks.ModelCheckpoint('/home/sfaria/Python/minst_models/'+str_name+ '_ministMODEL.h5', monitor='loss', verbose=1, save_best_only=True, save_weights_only=True, mode='auto', period=1)    
